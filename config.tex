...
\definecolor{infoboxcolor}{RGB}{240, 240, 255} % Define the bluish grey color
...
\newcommand{\infobox}[4]{
  \clearpage
  \ifodd\value{page}\hbox{}\newpage\fi % Start on an even page
  \pagecolor{infoboxcolor}
  % Adjust outer margin for even page
  \begin{adjustwidth}{-\marginparwidth-\marginparsep}{0pt}
    \begin{multicols}{2} % Start two-column layout
      #2 % Insert first part of your text content here
    \end{multicols}
  \end{adjustwidth}
  \clearpage
  % Adjust outer margin for odd page
  \begin{adjustwidth}{0pt}{-\marginparwidth-\marginparsep}
    \begin{multicols}{2} % Restart two-column layout
      #3 % Insert second part of your text content here
    \end{multicols}
    \includegraphics[width=\dimexpr\textwidth+\marginparwidth+\marginparsep\relax]{#1} % Include your image
      #4
  \end{adjustwidth}
  \clearpage
  \nopagecolor
