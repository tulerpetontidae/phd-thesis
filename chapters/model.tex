...
This chapter is largely based on the supplementary methods and technical results from \textcite{Lomakin2022-ks} that was published in Nature. You can find all the code on [Github](https://github.com/gerstung-lab/BaSISS).
...
\explain{}{\textbf{\emph{reverse KL divergence}} \marginfig{side-plot-KL-PQ.pdf} In the case of a non-alternative selection between two opposing entities, both will manifest suboptimally}
