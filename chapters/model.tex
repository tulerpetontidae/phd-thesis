...
I model \ac{BaSISS} counts as being \explain{Negative Binomial}{is equivalent to the Poisson distribution with a Gamma prior on the mean parameter $\lambda$ \marginfig{side-plot-nb-dist.pdf}} distributed given an unobserved mean detection level $\mathbf{M}_{x,y,a}$ and over-dispersion parameter ${\alpha}_a$ which accounts for unexplained variance:
