...
This chapter is largely based on the supplementary methods and technical results from \fullauthcite{Lomakin2022-ks}. You can find all the code on \href{https://github.com/gerstung-lab/BaSISS}{Github}.
...
\section{Background}
\subsection{The \ac{BaSISS} protocl}
